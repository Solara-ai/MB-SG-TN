class Strings {
  ...
  final String repetEnddate = 'Repet end date';
  final String gender = 'Gender';
  final String AI_driven_work_performance = 'AI-driven work performance';
  final String No_event_here = 'No event here';
  final String login = 'Login';
  final String error = 'Error';
  final String Achieved_score = 'Achieved score';
  String evaluationOfheath (String description)  => 'Evaluation of health : ${description}';
  final String Advice_for_you = 'Advice for you';
  final String event_of_you = 'Your priority event';
  final String performance_evaluation = 'Performance evaluation';
  final String edit_task = 'Edit task';
  final String edit_epic = 'Edit epic';
  final String There_is_no_chart_here = 'There is no chart here.';
