...
class $LibResDrawablesGen {
  ...
  /// File path: lib/res/drawables/empty_img.png
  AssetGenImage get emptyImg =>
      const AssetGenImage('lib/res/drawables/empty_img.png');
  ...
  /// File path: lib/res/drawables/ic_app.png
  AssetGenImage get icApp =>
      const AssetGenImage('lib/res/drawables/ic_app.png');
  ...
  /// File path: lib/res/drawables/ic_not_see_password.svg
  String get icNotSeePassword => 'lib/res/drawables/ic_not_see_password.svg';
  ...
  /// File path: lib/res/drawables/ic_search.svg
  String get icSearch => 'lib/res/drawables/ic_search.svg';

  /// File path: lib/res/drawables/ic_see_password.svg
  String get icSeePassword => 'lib/res/drawables/ic_see_password.svg';
  ...
  /// File path: lib/res/drawables/ic_tab_calendar.svg
  String get icTabCalendar => 'lib/res/drawables/ic_tab_calendar.svg';
