...
*/
// hàm này sẽ có tác dụng đó chính là có thể truyền dữ liệu khi chuyển page , khác với navigator ultils .
extension ContextNavigation on BuildContext {
  ...
  // sử dụng để quay lại màn hình đầu tiên nhưng đẩy 1 màn hình mới lên màn hình đầu tiên đó 
  Future<T?> popToFirstAndPushScreen<T>(Widget screen, {Object? arguments}) {
    Navigator.popUntil(this, (route) => route.isFirst);
    return pushScreen(screen, arguments: arguments);
  }
  // sử dụng để quay lại màn hình đầu tiên và thay thế màn hình đầu tiên bằng một màn hình khác.
